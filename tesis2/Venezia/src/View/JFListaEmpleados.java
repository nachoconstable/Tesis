...
public class JFListaEmpleados extends javax.swing.JFrame {
    ...
    /**
     * Creates new form JFListaEmpleados
     */
      private HeladeriaManager g;
    public JFListaEmpleados() throws SQLException {
        initComponents();
    ...
    private void tablaempleadosMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaempleadosMousePressed
         if(evt.getClickCount()==2){
             ...
             JFVentas.txtcodigo.setText(cod);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(JFListaEmpleados.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
